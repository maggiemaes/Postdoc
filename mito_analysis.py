...
def get_group_data(group_folder):
    ...
    data2 = tools.get_loc_files(f'/Users/mmaes/Documents/Python_scripts/{group_folder}/*.csv')
...
def raw_data():
    ...
    wt_raw = get_group_data('raw_data')
    ucp2_raw = get_group_data('ucp2_raw_data')
    rd10_raw = get_group_data('rd_raw_data')



    # fnames = glob.glob('/Users/mmaes/Documents/Python_scripts/ucp2/**/*.csv')
    # fnames = [f for f in fnames if not f.endswith('Overall.csv')]
    # data1 = tools.get_stat2_files(fnames)
...
def mitos():
    ...
    conditions = {'naive': ['ipl', 'opl'], 'd5os': ['ipl', 'opl'], 'd5od': ['ipl', 'opl'],'d14os': ['ipl', 'opl'], 'd14od': ['ipl', 'opl'], 'd35os': ['ipl', 'opl'], 'd35od': ['ipl', 'opl'], 'rd': ['gcl', 'ipl', 'opl'], 'wt': ['gcl', 'ipl', 'opl']}
